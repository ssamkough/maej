...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* RANDOMIZED: Color, Letter, Number */

        /* BUTTONS */
        final Button colorB = (Button) findViewById(R.id.colorButton);
        final Button letterB = (Button) findViewById(R.id.letterButton);
        final Button numberB = (Button) findViewById(R.id.numberButton);
