...
public class MinecraftActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final MediaPlayer mp1 = MediaPlayer.create(this, R.raw.creeper);
        ...
        final MediaPlayer mp3 = MediaPlayer.create(this, R.raw.hurt);
        ...
        final MediaPlayer mp4 = MediaPlayer.create(this, R.raw.piston);
